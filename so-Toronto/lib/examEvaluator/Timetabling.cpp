...
/// ADDED: NLeite - April 2015
///
Timetabling::Timetabling(string const& _torontoDatasetPath, string const& _outputDir, string const& _torontoDatasetName)
    : Timetabling()
{
    torontoDatasetPath = _torontoDatasetPath;
    outputDir = _outputDir;
    torontoDatasetName = _torontoDatasetName;
}
...
//	strcat(nameT, ".sol");
    ///
    /// ADDED: NLeite - April 2015
    /// Concat Output dir to solution file name
    ///
    char nameT[256];
    strcpy(nameT, this->outputDir.c_str());
    strcat(nameT, name);
    strcat(nameT, ".sol");
...
//	strcat(nameS, ".RES");
    ...
    ///
    /// ADDED: NLeite - April 2015
    /// Concat Toronto path name to file name
    ///
    char nameS[256];
    strcpy(nameS, this->torontoDatasetPath.c_str());
    strcat(nameS, name);
    strcat(nameS, ".RES");
...
//	strcat(nameE, ".exm");
    ...
    ///
    char nameE[256];
    strcpy(nameE, this->torontoDatasetPath.c_str());
    strcat(nameE, name);
    strcat(nameE, ".exm");

...
public:
    ...
    /// ADDED: NLeite - April 2015
    ///
    Timetabling(std::string const& _torontoDatasetPath, std::string const& _outputDir, std::string const& _torontoDatasetName);
...
private:
    ...
    /// ADDED: NLeite - April 2015
    ///
    std::string torontoDatasetPath;
    std::string outputDir;
    std::string torontoDatasetName;
};
